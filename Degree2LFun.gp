...
classgen(K, cyc, gen, id, n) = 
{   
    if(cyc == [],
        print("Current Ideal: ", id);
    ...
    for(i = 0, cyc[1]-1,
        ...
        classgen(K, cyc[^1], gen[^1], curr_id, n);
    );
}
...
rossi(pol, ss) =
{
    ...
    print("Group Structure: ", gen, " " , cyc);

    s = 0;
    classgen(K, cyc, gen, [1, 0; 0, 1], n);
    s *= ((n-1)!) ^ 2 / 2;

    print("L(", K.pol, ", ", ss, ") = ", polcoeff(s, 0));
}  
